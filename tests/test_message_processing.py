...
class TestMessageProcessing:
    ...
    @pytest.mark.parametrize(
        ...
        (
                ...
                ("+50 zarplata", ParsedMessage(amount=D(50), description="zarplata", is_income=True)),
                ("+50.11 zarplata", ParsedMessage(amount=D('50.11'), description="zarplata", is_income=True)),
                ("100-25 food", ParsedMessage(amount=D(75), description="food")),
                ("100-25-15 food", ParsedMessage(amount=D(60), description="food")),
                ("100-25-15+5 food and stuff", ParsedMessage(amount=D(65), description="food and stuff")),
                ("50+25-30+2.5 food and stuff", ParsedMessage(amount=D('47.5'), description="food and stuff")),
        ),
        ids=(
                "simple",
    ...
    async def test_message_parsing(self, message_text: str, expected_result: tuple[D, str]):
